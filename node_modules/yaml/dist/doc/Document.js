...
class Document {
    ...
    toString(options = {}) {
        ...
        const ctx = stringify.createStringifyContext(this, options);
        let chompKeep = false;
        let contentComment = null;
        if (this.contents) {
            if (Node.isNode(this.contents)) {
            ...
            let body = stringify.stringify(this.contents, ctx, () => (contentComment = null), onChompKeep);
            if (contentComment)
