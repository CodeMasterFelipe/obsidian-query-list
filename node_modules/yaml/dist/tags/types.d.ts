...
export declare type SchemaId = 'core' | 'failsafe' | 'json' | 'yaml11';
export declare type TagId = 'binary' | 'bool' | 'float' | 'floatExp' | 'floatNaN' | 'floatTime' | 'int' | 'intHex' | 'intOct' | 'intTime' | 'null' | 'omap' | 'pairs' | 'set' | 'timestamp';
interface TagBase {
    /**
...
export declare type TagObj = ScalarTag | CollectionTag;
export declare type TagValue = TagId | ScalarTag | CollectionTag;
export {};
